using cRPCClient.Models;
using Microsoft.AspNetCore.Mvc;
using System.Diagnostics;
using Grpc.Net.Client;
using Vilau_Paula_Lab10;
using System.Threading;
using Grpc.Core;

namespace cRPCClient.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> ClientStreaming(int[] statuses)
        {
            var channel = GrpcChannel.ForAddress("https://localhost:5001");
            var client = new Greeter.GreeterClient(channel);
            Dictionary<string, string> statusDict = new Dictionary<string, string>();
        ...
        public async Task<IActionResult> BiDirectionalStreaming(int[] statusNo)
        {
            var channel = GrpcChannel.ForAddress("https://localhost:5001");
            var client = new Greeter.GreeterClient(channel);
            Dictionary<string, string> statusDict = new Dictionary<string, string>();
